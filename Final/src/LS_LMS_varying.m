...
L = 10;              % filter length
alpha = 2e-3;    % step size
N = 24;             % MAF fileter length
...
title("Data Square error for Varying Channel Case 1");
xlabel("symbols");
ylabel("|e|^2");
figure
plot(1:interval:data_length * total_operation, J2_data(1:interval:data_length * total_operation))
title("Data Square error for Varying Channel Case 2");
xlabel("symbols");
ylabel("|e|^2");
...
fprintf('Varying Channel Case 1 EVM is %.2f %% \n',evm_1(total_length*total_operation));
fprintf('Varying Channel Case 2 EVM is %.2f %% \n',evm_2(total_length*total_operation));
fprintf('Varying Channel Case 1 BER is %.5e \n',errorCount1/(2*train_length*total_operation));
fprintf('Varying Channel Case 2 BER is %.5e \n',errorCount2/(2*train_length*total_operation));

%% ==================== Save the result ====================
[ans_varying_1, ans_varying_2] = QPSK_symbol2bit(result_1, result_2);
%save(['../ans/ans_varying_1.mat'], 'ans_varying_1');
save(['../ans/ans_varying_2.mat'], 'ans_varying_2');